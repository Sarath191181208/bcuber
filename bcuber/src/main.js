...
const trainingManager = new TrainingManager({
  ...
  generateScramble: async () => { const x = await randomScrambleForEvent("333"); return x.toString() },
  autoScrambleOnSolve,
...
const toggleAutoTimer = async () => {
  ...
  trainingManager.setTurnInspectionOnAutomatically(turnInspectionOnAutomatically)
